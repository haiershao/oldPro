...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = NSLocalizedString(@"pull_down_refresh", nil);
        self.releaseToRefreshText = NSLocalizedString(@"release_refresh", nil);
        self.refreshingText = NSLocalizedString(@"loading_label", nil);
    }
    return self;
}
...
//        formatter.dateFormat = NSLocalizedString(@"last_fresh_date", nil); //@"今天 HH:mm";
