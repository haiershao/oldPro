...
@interface HWMyShowViewController ()<UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource, WMPlayerDelegate, findCommonCellDelegate>{
...
@implementation HWMyShowViewController
...
- (void)setUpNav{
    ...
    titleLabel.text = @"我行我秀";
    titleLabel.font = [UIFont systemFontOfSize:14];
    self.navigationItem.titleView = titleLabel;
}

+(instancetype)myShowViewController{

    return [[HWMyShowViewController alloc] initWithNibName:@"HWMyShowViewController" bundle:nil];
}
...
-(void)addMJRefresh{
    __weak __typeof(&*self)weakSelf = self;
    __unsafe_unretained UITableView *tableView = weakSelf.tableView;
    NSArray *para = @[@"qry_videolist", @"gentime", @"1"];
    // 下拉刷新
