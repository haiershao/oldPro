...
@interface HWBeautifulViewController ()<UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource, WMPlayerDelegate, findCommonCellDelegate>{
...
@implementation HWBeautifulViewController
...
+(instancetype)beautifulViewController{

    return [[HWBeautifulViewController alloc] initWithNibName:@"HWBeautifulViewController" bundle:nil];
}
-(void)addMJRefresh{
    __weak __typeof(&*self)weakSelf = self;
    __unsafe_unretained UITableView *tableView = weakSelf.tableView;
    NSArray *para = @[@"qry_videolist", @"gentime", @"4"];
    // 下拉刷新
