...
@interface HWSharesViewController ()

@end

@implementation HWSharesViewController
...
+(instancetype)sharesViewController{

    return [[HWSharesViewController alloc] initWithNibName:@"HWSharesViewController" bundle:nil];
}
