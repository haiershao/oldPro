...
@interface HWFansViewController ()

@end

@implementation HWFansViewController
...
+(instancetype)fansViewController{
    
    return [[HWFansViewController alloc] initWithNibName:@"HWFansViewController" bundle:nil];
}
